...
translate polish s14_b5f4a6bb:
    ...
    b "W poniedziałek ponownie zaczęły się zajęcia w szkole. Koniec końców, był to zwykły dzień... dopóki nie wpadłem nagle na Lamparta, gdy wychodziłem z popołudniowych zajęć. "
...
translate polish s14_e230227a:
    ...
    b "Najbezpieczniej jest w tym momencie uznać, że wykuł mój plan zajęć na pamięć. "
...
translate polish s14_ecbf6f77:
    ...
    avt "\"Lamparcie, martwiłem się, że już nie wrócisz. Cieszę się.\" "
...
translate polish s14_eb0bb9c6:
    ...
    lpd disappointed "\"...Wróciłem, przeprosić Liao.\" "
...
translate polish s14_45cf3e58:
    ...
    avt "\"Przeprosić? Jest w porządku. Serio, nie masz za co przepraszać...\" "
...
translate polish s14_c961b260:
    ...
    avt "\"Przyjmuję twoje przeprosiny. Ale dla jasności, w ogóle się na ciebie nie gniewałem.\" "
...
translate polish s14_9bf03e02:
    ...
    lpd disappointed "\"Musi ciągle przeprosić.\" "
...
translate polish s14_b98e74a5:
    ...
    lpd obsessed "\"Liao, nie ma zajęć. Pójdzie ze mną?\" "
...
translate polish s14_88936673:
    ...
    b "Wydaje mi się, że chce mi zadośćuczynić. No dobra, spędzę z nim trochę czasu."
...
translate polish s14_a364679a:
    ...
    b "Pantera prowadzi mnie do Ściany Luster, gdzie wczoraj wszystko się wydarzyło."
...
translate polish s14_09840ce6:
    ...
    lpd obsessed "\"Liao... Słaby tancerz. Pozwolić Liao tańczyć. Ćwiczyć, stanie się lepszym tancerzem.\" "
...
translate polish s14_72573ae3:
    ...
    tig normal "\"...Nieźle. Jeżeli Liao będzie w stanie samodzielnie to zatańczyć, to nikt nie będzie miał podstaw by coś podejrzewać. Jedynie musi mówić, że ćwiczył w tajemnicy\" "
...
translate polish s14_e7680fbb:
    ...
    avt "\"Myślę, że to moze zadziałać.\" "
...
translate polish s14_10520d81:
    ...
    b "Chce, żebym ćwiczył... już sama próba wczoraj była wyczerpująca. Nie wiem, czy dam radę. Ten układ jest {i}daleki{/i} \ od tego, co mógłbym nazwać prostym. "
...
translate polish s14_46976bcf:
    ...
    b "Ale chce wszystko naprawić. Jak mógłbym mu odmówić? Może i nie będę w stanie tego zrobić, ale mogę w sumie spróbować. Przynajmniej polepszy to relację Lamparta i Tygrysa. "
...
translate polish s14_0b398fa2:
    ...
    b "Lampart zaczyna mnie uczyć. Na początku kontroluje mnie, tak jak wcześniej, pozwalając mojemu ciału zbudować pamięć mięśniową, kiedy przechodzimy przez kolejne kroki"

    b "Później mam okazję, by samemu przejść przez rutynę, z pomocną łapą Pantery w trudnych momentach. "
...
translate polish s14_21a84a54:
    ...
    b "Z pomocą jego mocy szybko zapamiętuję kolejne kroki, ale nadal mam problemy z utrzymaniem tempa. Ciągle próbujemy, powoli podnosząc moją szybkość, układ po układzie. "

    b "Po godzinie czuję, jak moje ciało zaczyna się buntować, mięśnie płoną, błagając o przerwę. Jedynie moja determinacja utrzymuje mnie na nogach, aż przejdziemy kolejny raz cały układ, zanim w końcu padam wycieńczony. "
...
translate polish s14_8e818211:
    ...
    avt "\"Uff- Myślę, że faktycznie mi się to udało. *dyszę* Czy to wszystko?\" "
...
translate polish s14_5ac32375:
    ...
    tig normal "\"Liao nie da rady kontynuować. Wystarczy.\" "
...
translate polish s14_aba43e17:
    ...
    b "Odchodząc, Lampart kiwa głową na mnie. Kiedy wraca, trzyma napój w łapie. "
...
translate polish s14_cab0ce08:
    ...
    b "Tym razem nie była to kawa, lecz chłodny orzeźwiający napój owocowy. "

    b "Ostatecznie nauczyłem go jak użwać automatu po ostatnim razie, więc pewnie wziął trochę pieniędzy z mojego portfela, który jest w mojej kurtce zawieszonej na pobliskim krześle. "
...
translate polish s14_c768688c:
    ...
    b "WYpiłem trochę soku i wytarłem pot z czoła. Lampart cicho obserwuje mnie jak piję, ale widać, że myśli o czymś poważnym. "
...
translate polish s14_d23b7177:
    ...
    avt "\"O co chodzi? Chcesz mi coś powiedzieć?\" "
...
translate polish s14_1953ef86:
    ...
    b "Znamy się już na tyle, że czytam go jak otwartą książkę. "
...
translate polish s14_818adae2:
    ...
    b "Nie odpowiedział, jak i też w ogóle się nie poruszył. Może się zastanawia, czy powinien wrócić ze mną do domu czy nie?"
...
translate polish s14_c6a8913f:
    ...
    b "Jeżeli znowu odejdzie, to nie chcę, by zadziało się to tak samo jak wczoraj."

    b "Musimy przynajmniej wyjaśnić sobie kilka spraw... Ale naprawdę nie mogę tego zrobić tutaj, nie ryzykując tego, że ktoś przechodząc zobaczy mnie gadającego do samego siebie. "
...
translate polish s14_a6d6e7e8:
    ...
    avt "\"Ściemnia się i {i}napraaaaaawdęęęęęę{/i} \ muszę wziąć prysznic! Myślę, że czas najwyższy wracać, co nie? \" "
...
translate polish s14_be9e7ade:
    ...
    b "Staram się utrzymać luźny i wesoły ton, chcąć pomóc Lampartowi poczuć się \nmile widzianym"
...
translate polish s14_12f768f9:
    ...
    lpd normal "\"Liao będzie się martwił, jeżeli nie wróci do domu?\" " with flash
...
translate polish s14_dc2d39aa:
    ...
    tig frown "\"Jeżeli masz na myśli powrót Liao do jego rodzinnej miejscowości, to oczywiście, że będzie. Nawet jeżeli chce ci pomóc, musi wrócić.\" "
...
translate polish s14_e8bdee9d:
    ...
    lpd normal "\"Wraca do domu, nie może iść do Wutai?\" "
...
translate polish s14_16222f01:
    ...
    avt "\"Nadal możemy znaleźć jakieś rozwiązanie... ale nie będzie to proste. Wątpię, żebym mógł zostać tam długo, nawet w trakcie ferii i wakacji. Nie jestem nawet pewien, czy moja rodzina pozwoli mi pójśc tam po skończeniu szkoły...\" "
...
translate polish s14_f1e9c15d:
    ...
    tig frown "\"Nie mówiąc już o jego egzaminach\" "
...
translate polish s14_cbd6db69:
    ...
    avt "\"Dlatego powiedziałem, że może tylko w trakcie ferii i wakacji. Mógłbym przyjechać na tydzień lub dwa na raz i moja rodzina pewnie nadal będzie sprawiała problemy.\" "
...
translate polish s14_94aedf7b:
    ...
    lpd disappointed "\"...Nie może być wyrocznią?\" "
...
translate polish s14_e5893387:
    ...
    avt "\"Jeżeli musiałbym być tam codziennie, to nie będę mógł.\" "
...
translate polish s14_6f5c0c05:
    ...
    avt "\"Naprawdę chcę ci pomóc, ale nie ma możliwości, żebym mógł zostać w Wutai na długo...\""
...
translate polish cg_lpd_attack_2702454b:
    ...
    lpd normal "\"Potrzebuję wyroczni.\" "
...
translate polish cg_lpd_attack_992a37af:
    ...
    lpd normal "\"Liao nie musi przychodzić.\" "
...
translate polish cg_lpd_attack_ca8b4262:
    ...
    lpd normal "\"Pożyczę moc od Liao.\" "
...
translate polish cg_lpd_attack_cd2ca577:
    ...
    lpd normal "\"Z mocą mogę się komunikować. To nie musi być Liao.\" "
...
translate polish cg_lpd_attack_6a86bdb1:
    ...
    tig frown "\"Hej, o czym ty gadasz? Moc Liao jest...\" "
...
translate polish cg_lpd_attack_b45da84a:
    ...
    lpd disappointed "\"Potrzebuję tego. Liao.\" "
...
translate polish cg_lpd_attack_18f2773e:
    ...
    lpd disappointed "\"Proszę użycz mi...\" "
...
translate polish cg_lpd_attack_32facdd1:
    ...
    b "Lampart wyciąga łapę w moim kierunku. Nie rozumiem co on robi, ale... {w=0.5}czuję się przez to nieswojo... "
...
translate polish cg_lpd_attack_c0829bd7:
    ...
    b "Tygrys szarżuje w moim kierunku. Przygotowany na jego atak, Lampart wystrzeliwuje piorun ze swojej łapy." with vshake
...
translate polish cg_lpd_attack_ec11b67c:
    ...
    tig pain2 "\"Nic się nie stało, nic mi nie jest...\" "
...
translate polish cg_lpd_attack_178ee706:
    ...
    tig pain2 "\"Hey, ty! Co ty sobie myślisz! Jesteś świadomy, że jeżeli odbierzesz Liao jego moce...\" "
...
translate polish cg_lpd_attack_b046360e:
    ...
    tig pain2 "\"...Więc dlaczego?!\" " with vshake
...
translate polish cg_lpd_attack_2cd60a22:
    ...
    lpd disappointed "\"Nie ma wyboru.\" "
...
translate polish cg_lpd_attack_c41045cc:
    ...
    tig pain2 "\"...Myliłem się co do ciebie, ale nie pozwolę ci kontynuować!\" "
...
translate polish cg_lpd_attack_7c55583d:
    ...
    lpd normal "\"Nie możesz wygrać.\" " with flash_cyan
...
translate polish cg_lpd_attack_6c8ef8b9:
    ...
    tig angry_scar "\"Ha- Nawet jeżeli to prawda... Jakiż bóg mógłby opuścić swoich wyznawców!\" " with flash
...
translate polish cg_lpd_attack_2d2112fb:
    ...
    b "Lampart patrzy się na mnie chłodno... Wyraz jego rozpaczy był tak poważny, że aż trudno mi było uwierzyć, że to on."
...
translate polish cg_lpd_attack_f6baa611:
    ...
    b "Lampart ponownie podnosi swoją łapę. "
...
translate polish cg_lpd_attack_a9ec5f14:
    ...
    tig angry_scar "\"Liao, odsuń się!\" " with flash_cyan
...
translate polish cg_lpd_attack_ddb3530f:
    ...
    b "Lampart podchodzi w moim kierunku. "
...
translate polish cg_lpd_attack_f96ca84b:
    ...
    b "Tygrys podrywa się z podlogi, zasłaniając mnie swoim ciałem. " with flash
...
translate polish cg_lpd_attack_8ed370e3:
    ...
    tig pain2 "\"Liao, uciekaj! Nie zatrzymam go...\" " with vshake
...
translate polish cg_lpd_attack_252f2b30:
    ...
    tig pain2 "\" Nie martw się. Jestem w końcu tygrysim strażnikiem...\" "
...
translate polish cg_lpd_attack_d6f7b90a:
    ...
    xiunuosi eyes_close "\"Hynos, na usługach Dwunastki Miejskiego Boga.\" " with flash
...
translate polish cg_lpd_attack_80299a0f:
    ...
    xiunuosi eyes_close "\"Jesteś aborygeńskim bogiem? Dlaczego walczysz z tym tygrysim strażnikiem?\" "
...
translate polish cg_lpd_attack_f78ce227:
    ...
    xiunuosi eyes_close "\"Cóż za okropne zachowanie... Czy próbujesz zranić tego młodzieńca?\" "
...
translate polish cg_lpd_attack_7f5a38c6:
    ...
    lpd normal "\"Chcę pomóc moim ludziom.\" "
...
translate polish cg_lpd_attack_4af92a48:
    ...
    lpd normal "\"Potrzebuje mocy Liao. Ale Liao... nie idzie.\" "
...
translate polish cg_lpd_attack_8464a501:
    ...
    xiunuosi eyes_close "\"Czyli mówisz, że zaatakowałeś, ponieważ ten młodzieniec odmówił ci pomocy?\" "
...
translate polish cg_lpd_attack_e1399e23:
    ...
    lpd disappointed "\"Potrzebuję mocy Liao.\" "
...
translate polish cg_lpd_attack_2e56e4d9:
    ...
    xiunuosi eyes_close "\"I w tym celu wolisz być nam wrogiem?\" "
...
translate polish cg_lpd_attack_3f056067:
    ...
    lpd normal "\"Ja potrzebuję mocy Liao.\" "
...
translate polish cg_lpd_attack_5e5d5bed:
    ...
    xiunuosi eyes_close "\"Zdaje się, że nie masz już nic więcej do dodania. W takim razie...\" "
...
translate polish cg_lpd_attack_8c264edf:
    ...
    xiunuosi eyes_open "\"Ja będę ci przeciwnikiem.\" " with flash
...
translate polish cg_lpd_attack_7119e5d6:
    ...
    b "Kiedy Hynos blokuje ścieżkę między mną a Lampartem, Tygrys korzysta z tej okazji, chwytając mnie za ramię i ruszając do domu tak szybko, jak to możliwe. "
...
translate polish cg_lpd_attack_24c5a740:
    ...
    tig pain2 "*wdech* *wydech* \"Wiedziałem, że ten aborygen coś planował!\" "
...
translate polish cg_lpd_attack_7b671cfb:
    ...
    b "Nadal nie mogę uwierzyć, że mnie zaatakował. Podnoszę wzrok na Tygrysa, na jego podarte i zniszczone ubrania. Nie mogę zaprzeczyć temu, co się stało.\" "
...
translate polish cg_lpd_attack_94419c77:
    ...
    b "Ciało Tygrysa... on jest duchem, więc jakim sposobem jego ubrania zostały uszkodzone przez ataki Lamparta? Nie powinno to być.... {w=0.5}Nieważne, teraz nie ma to znaczenia. "
...
translate polish s14_branch1_9160d896:
    ...
    tig pain2 "\"Ten Hynos powinien dać nam trochę czasu. Jednakże... Wątpię, by zajął go na zbyt długo.\" "
...
translate polish s14_branch1_10f435ee:
    ...
    tig frown "\"Nie mam pewności, ale to co wiem na pewno, to to, że podwładni nie są łatwymi celami. Nie umrą nawet jeżeli ich pokona.\" "
...
translate polish s14_branch1_114e552e:
    ...
    tig lift "\Nie chciałem tak szybko o tym wspominać...\" "
...
translate polish s14_branch1_88ab5a1d:
    ...
    tig normal "\"Ale nie mamy teraz czasu. Liao, jesteś świadomy, że Jitong może wezwać bóstwo by posiadło jego ciało, prawda?\" "
...
translate polish s14_branch1_ec074b3b:
    ...
    avt "\"Eee- Jasne. Więc prosisz mnie o zgodę na opętanie mojego ciała?\" "
...
translate polish s14_branch1_f5cd6a69:
    ...
    tig normal "\"Wezwanie bóstwa by posiadło twoje ciało nie jest wbrew pozorom takie proste. Wymaga to tego, by tygrysi strażnik i Jitong bardzo dobrze znali siebie nawzajem.\" "

    tig normal "\"Jitong musi z własnej woli oddać swoje ciało pod opiekę tygrysiego strażnika.\" "

    tig normal "\"Wiedz, że nawet w przypadku rodziny Lin... jeden Jitong może zostać opętany tylko przez jednego tygrysiego strażnika w ciągu swojego życia.\" "
...
translate polish s14_branch1_1f4ed997:
    ...
    b "Po co w ogóle dawałeś mi nadzieję..."
...
translate polish s14_branch1_f722b39b:
    ...
    tig embarrassed "\"...Nadal możemy to osiągnąć.\" "
...
translate polish s14_branch1_b01ae6a5:
    ...
    tig embarrassed "\"Sposób, który pomoże nam się zrozumieć... Albo inaczej mówiąc, pomoże ci poczuć się komfortowo, gdy cię opętam.\" "
...
translate polish s14_branch1_ab30765c:
    ...
    b "Jest to trochę... niejasne. Co on planuje zrobić? "
...
translate polish s14_branch1_043c1138:
    ...
    avt "\"Więc, jak opętanie mnie może nam pomóc w tej sytuacji?\" "
...
translate polish s14_branch1_74b8e30a:
    ...
    tig normal "\"Jeżeli opętam twoje ciało, moja duchowa moc będzie cię chronić bezpośrednio. Ponieważ Lampart jest bytem czysto duchowym, nie będzie w stanie cię skrzywdzić w żaden sposób.\" "
...
translate polish s14_branch1_08d4d67f:
    ...
    b "Czyli duchowa moc Tygrysa mnie osłoni? Brzmi to tak, jakby miało mi to zapewnić bezpieczeństwo, ale czy Lampart naprawdę zrezygnuje z tego powodu? "
...
translate polish s14_branch1_b600b01f:
    ...
    tig normal "\"Za sprawą twojego ciała moja moc duchowa będzie bezpośrednio wpływać na obiekty. Chociaż Lampart może być silniejszy, ta jedna różnica może nam pomóc w pokonaniu go.\" "
...
translate polish s14_branch1_47c50abb:
    ...
    avt "\"Ale czy... wtedy go nie skrzywdzimy?\" "
...
translate polish s14_branch1_d0740676:
    ...
    tig frown "\"Nadal się o niego martwisz? Bez wątpliwości tak potężny duch jak on tak łatwo nie umrze. Najpewniej się wycofa po porażce, do Wutai czy gdziekolwiek indziej.\" "
...
translate polish s14_branch1_8ec6d6b1:
    ...
    tig frown "\"Jego moc może i osłabnie, ale będzie cały. Nie dałbym rady go zranić aż tak bardzo.\" "
...
translate polish s14_branch1_39892870:
    ...
    avt "\"...Rozumiem. Więc jak to zrobimy?\" "
...
translate polish cg_tig_possessing_9347ed52:
    ...
    lpd normal "\"Potrzebuję twojej mocy.\" "
...
translate polish cg_tig_possessing_15835563:
    ...
    lpd normal "\"...Wezmę siłą. Tygrysi strażnik mnie nie pokona.\" "
...
translate polish cg_tig_possessing_72fd8d2e:
    ...
    tig frown "\"Oh? Jakież to {i}roztropne{/i} z twojej strony. Bardzo chętnie zobaczę, jak próbujesz.\" "
...
translate polish cg_tig_possessing_05388cfd:
    ...
    tig frown "\"No dalej, to jest to, czego chcesz. Naprawdę chciałem wierzyć, że jesteś mądrzejszy.\" "

    tig frown "\"Ale jak się spodziewałem, nie jesteś dobrą istotą, aborygenie. Popełniłem błąd pozwalając ci zostać przy Liao.\" "
...
translate polish cg_tig_possessing_47f0a056:
    ...
    tig angry "\"Więc teraz mam okazję naprawić swoje błędy!\" "
...
translate polish cg_tig_possessing_3418a25f:
    ...
    lpd disappointed "\"Po prostu chcę...\" "
...
translate polish cg_tig_possessing_46423047:
    ...
    tig angry "\"Niestety nie uda ci się to. Liao jest pod moją ochroną!\" " with vshake
...
translate polish cg_tig_possessing_fe8831d1:
    ...
    b "Lampart przybiera pozycję bojową, a Tygrys wyciąga swoje łapy w moim kierunku. "
...
translate polish cg_tig_possessing_d89c9a2a:
    ...
    b "Chwytam łapy Tygrysa, a on mocno mnie ściska. Strumień energii przepływa od niego do mnie. "

    b "I nagle nie trzymam niczego. Jedyne co zostało, to ciepła para unosząca się z moich dłoni. "
...
translate polish cg_tig_possessing_41bd8450:
    ...
    b "Tygrys zniknął sprzed moich oczu, ale czuję jego siłę, we mnie. " with flash
...
translate polish cg_tig_possessing_d76169b4:
    ...
    b "Moje dłonie ruszają się same z siebie. Na początku jestem tym zaskoczony, ale Tygrys mnie przygotował na to, więc się uspokoiłem. "
...
translate polish cg_tig_possessing_8a561c52:
    ...
    b "Po chwili widzę, jak moje dłonie się trzęsą, tak jakby moc Tygrysa we mnie była niestabilna. Może nie może mnie opętać, jeżeli opieram się jego ruchom? "
...
translate polish cg_tig_possessing_c0111b4a:
    ...
    b "Moje ciało przyjmuje pozycję bojową. "
...
translate polish cg_tig_possessing_3042de8f:
    ...
    b "Moje plecy były nisko opuszczone, a stopy szeroko rozstawione, co pozwalało utrzymać nisko położony środek ciężkości. Moje ciało napięło się jak Tygrys gotowy do skoku. "

    b "To tak, jakbym stanowił jedność z jego ruchami, nawet jeżeli wydaje się to trochę dziwne... "
...
translate polish cg_tig_possessing_513985b7:
    ...
    b "Lampart wygląda na zaskoczonego, wypuszczając małą błyskawicę by sprawdzić, co się stanie. Tygrys nawet nie przejął się unikaniem tego. " with flash_cyan
...
translate polish cg_tig_possessing_b3093c8d:
    ...
    b "Błyskawica uderzyła mnie w czoło na próżno, wywołując tylko mrugnięcie, nic więcej." with flash
...
translate polish cg_tig_possessing_cdaa8a91:
    ...
    b "Tygrys zaczyna mówić moim głosem. "
...
translate polish cg_tig_possessing_b574045f:
    ...
    tig2 "\"Powinieneś się zorientować, że nie możesz wygrać. Nie teraz, gdy Liao oddał mi swoje ciało! Nie teraz, gdy nasza moc może się objawić fizycznie!\" "
...
translate polish cg_tig_possessing_70c02eea:
    ...
    b "Lampart robi krok do przodu, przekraczając próg mojego pokoju. Jego dłonie uniesione przed nim. Tym razem już rozpoznaję jego ruchy. "
...
translate polish cg_tig_possessing_d6e75982:
    ...
    b "Tygrys obniża moje ciało w kierunku podłogi, przenosząc mój ciężar na lewej dłoni. Energia zaczyna się wzbierać w moich udach. "
...
translate polish cg_tig_possessing_cfcd2579:
    ...
    b "Niebieskie pociski strzlają z łap Lamparta. Moje ciało skacze wprost w atak Lamparta, próbując chwycić jego klatkę piersiową swoją dłonią, ale gwałtowny cios mnie odpycha. " with flash_cyan
...
translate polish cg_tig_possessing_a312c2a2:
    ...
    b "Moje ciało rzuca się ponownie w kierunku Lamparta w czasie, gdy kolejna salwa niebieskich piorunów leci w naszym kierunku. "

    b "Zdeterminowany, by nie popełnić tego samego błędu, Tygrys przesuwa moje ciało na bok, usuwając mnie z linii ognia i uderzając łapy Lamparta. "
...
translate polish cg_tig_possessing_6dd32b8e:
    ...
    b "Iskry gasną gdy Lampart bierze krok do tyłu, przyciskając ranną łapę drugą. Ciężko stwierdzić, jak bardzo jest ranny. "
...
translate polish cg_tig_possessing_41569086:
    ...
    b "Jednakże się nie wycofuje. Lampart rozkłada ramiona. Najpierw gromadzi się zielona aura, a następnie ze wszystkich kierunków wystrzeliwują promienie. Tygrys przygotował moje ciało na kolejną szarżę, ale szybko zauważyliśmy, że zielone promienie całkowicie oplotły moje ciało. " with flash_green
...
translate polish cg_tig_possessing_cda61a38:
    ...
    b "Pnącza oplatają moje ciało, krępując moje dłonie i stopy. Nie możemy się ruszyć. "
...
translate polish cg_tig_possessing_eacf9ab1:
    ...
    tig2 "\"Pnącza są czysto duchowe! Czysta iluzja!\" " with vshake
...
translate polish cg_tig_possessing_e92e1fc9:
    ...
    b "Lampart ma trudności z utrzymaniem swoich łap w powietrzu, tak jakby przeciągali niewidzialną linę z Tygrysem, który stara się wyrwać z duchowych pnączy. "
...
translate polish cg_tig_possessing_5f9246fc:
    ...
    tig2 "\"Cholera! Nadal jest bardzo potężny...\" "
...
translate polish cg_tig_possessing_91430277:
    ...
    b "Wydobywające się z moich ust słowa Tygrysa brzmią szorstko. Chociaż nie mam kontroli nad swoim ciałem czuję, jak bardzo jest napięte. "
...
translate polish cg_tig_possessing_cac2ae89:
    ...
    b "Ani pnącza ani Lampart się nie poddają mimo naszych wspólnych wysiłków. "
...
translate polish cg_tig_possessing_4566b041:
    ...
    b "Tygrys zaczął cicho ryczeć. " with flash_gold
...
translate polish cg_tig_possessing_6de2b6a2:
    ...
    tig2 "\"Grrr- Jesteśmy tak blisko- Musimy tylko- się- wydostać!\" "
...
translate polish cg_tig_possessing_0f270bae:
    ...
    b "Czy my przegrywamy? Tygrys i ja jesteśmy już... Czy to nie starczy? "
...
translate polish cg_tig_possessing_abf95c63:
    ...
    b "To nie może byc. Musi być jakieś wyjście! "
...
translate polish cg_tig_possessing_6913efc5:
    ...
    b "Jak mogę wzmocnić duchową moc Tygrysa? "
...
translate polish cg_tig_possessing_a2d5b00d:
    ...
    b "Jestem Jitongiem. Nie mogę tak po prostu zrzucić wszzystkiego na mojego tygrysiego strażnika. Muszę... "
...
translate polish cg_tig_possessing_1302fa39:
    ...
    b "Tygrys wydaje z siebie wściekły ryk, który jednak nie robi żadnego wrażenia na Lamparcie. "

    b "Powoli lecz pewnie podchodzi, zbliżając się do nas, krok za krokiem. "
...
translate polish cg_tig_possessing_910ab5c2:
    ...
    b "Mam to! Imię! Nadam mu imię, by wzmocnić jego moce! " with vshake
...
translate polish cg_tig_possessing_11125bcb:
    ...
    avt "\"Jesteś tygrysim strażnikiem rodziny Lin! Dlatego też zwać się będziesz Lin Hu!\" "
...
translate polish cg_tig_possessing_899f8983:
    ...
    b "Serce mi bije jak młot, zaciskając się w ciasny kłębek nerwów, który muszę rozerwać ze wszystkich sił. "
...
translate polish cg_tig_possessing_3f1a1139:
    ...
    avt "O-{w=0.2}Oczywiście jeżeli twoim życzeniem jest bronić członków rodziny Lin! \nLin Hu! Jeżeli tak jest, to pomóć mi!\" "
...
translate polish cg_tig_possessing_a15bc0d0:
    ...
    avt "\"Wspomóż mnie całą swoją mocą! Powstrzymaj... Powstrzymaj każdego, kto pragnie mnie skrzywdzić!\" "
...
translate polish cg_tig_possessing_6645e3c0:
    ...
    b "Nagłe BANG rozeszło się dookoła mnie i spowijające nas pnącza rozsypały się w rozbłysku słabego zielonego światła. Tygrys nie napiął nawet mięśnia by nas uwolnić. "

    b "On i ja stoimy razem, nasze spojrzenie utkwione w osłupiałej Panterze. "
...
translate polish cg_tig_possessing_8ba964c1:
    ...
    b "Lampart bierze krok w tył, po czym jednym susem wyskoczył na korytarz na zewnątrz mojego pokoju; wycofuje się, gdy jego postać rozpływa się w czarno-żółty cień, znikając nam z oczu. "
...
translate polish cg_tig_possessing_4048945d:
    ...
    b "Tygrys powoli pochodzi do drzwi i je zamyka. "
...
translate polish cg_tig_possessing_54fdbca9:
    ...
    b "Jak tylko zamek się zatrzasnął padłem na podłogę. W końcu chwila, by odpocząć. " with vshake
...
translate polish cg_tig_possessing_5bd4b387:
    ...
    tig normal "\"...Liao, wszystko w porządku?\" "
...
translate polish cg_tig_possessing_17ce93ee:
    ...
    tig normal "\"Część ludzi może się czuć kompletnie wyczerpana przez rytuał opętania. Jeżeli nie czujesz się dobrze, możesz odpocząć.\" "
...
translate polish cg_tig_possessing_1d54a31f:
    ...
    b "\"Nie czuję się źle. Mój umysł po prostu- stara się to wszystko ogarnąć. "
...
translate polish cg_tig_possessing_2e61c246:
    ...
    b "Koniec końców udało nam się odeprzeć atak Lamparta... i nadałem Tygrysowi imię... "
...
translate polish cg_tig_possessing_888ac1e4:
    ...
    avt "\"Imię, które ci nadałem. Podoba ci się?\" "
...
translate polish cg_tig_possessing_95a58a81:
    ...
    tig gentle "\"Oczywiście mógłbym powiedzieć, że każde imię nadane mi przez Liao byłoby wspaniałe, lecz...\" "
...
translate polish cg_tig_possessing_684adb3e:
    ...
    tig laugh_1 "\"Lin Hu, tygrys rodziny Lin. Proste i bezporśrednie, bardzo mi się podoba.\" "
...
translate polish s14_branch1_03_32f5c38d:
    ...
    b "Udało... nam się odeprzeć Lamparta. "
...
translate polish s14_branch1_03_adbac9e7:
    ...
    b "Mimo że zaatakował nas pierwszy... sposób, w jaki spojrzał tuż przed odejściem, mam wątpliwości, czy kiedykolwiek jeszcze wróci. "
...
translate polish s14_branch1_03_26ac9381:
    ...
    tig frown "\"Co z nim? Czy dopiero co nie uciekł od nas?\" "
...
translate polish s14_branch1_03_af5cd687:
    ...
    tig frown "\"Dlaczego- Czy ty nadal martwisz się jego odejściem?\" "
...
translate polish s14_branch1_03_0eb77707:
    ...
    avt "\"...Tak. Nie wiem czemu mnie zaatakował... Wąpię, żeby chciał mnie skrzywdzić.\" "
...
translate polish s14_branch1_03_6ef6e765:
    ...
    tig frown "\"Skrzywdzić? On chciał cię zabić!\" " with vshake
...
translate polish s14_branch1_03_3884e287:
    ...
    tig frown "\"Tak. Co według ciebie może oznaczać odebranie twoich duchowych mocy?\" "

    tig frown "\"Nie można tak po prostu rozdzielić mocy ducha. Odebranie tobie duszy... Cóż...\" "

    tig frown "\"Ujmę to w ten sposób. Byłoby to podobne do formatowania pamięci komputera. Wyczyszczenie tego, {i}kim{/i} \ jesteś, z twojego ciała- twoja osobowość- twoje wspomnienia, przepadły.\" "

    tig frown "\"Niczym by się to nie różniło od zabicia osoby znanej jako Lin Tian-Liao.\" "
...
translate polish s14_branch1_03_6cdd526d:
    ...
    tig angry "\"W co innego byś uwierzył? W to, że możesz odebrać sobie moc duchową, nie zmieniając przy tym tego, kim jesteś?\" "

    tig angry "\"Nawet RAM nie może zachować informacji bez mocy.\" "
...
translate polish s14_branch1_03_92712628:
    ...
    avt "\"A jednak udaje ci się opisać to tak swobodnie.\" "
...
translate polish s14_branch1_03_d766b8ec:
    ...
    tig frown "\"Po prostu starałem się przekazać to w taki sposób, żebyś mógł to zrozumieć.\" "
...
translate polish s14_branch1_03_009abacc:
    ...
    b "To jest dziwne. Czy Lampart rzeczywiście wiedział {i}dokładnie{/i} \ co robił? "
...
translate polish s14_branch1_03_lpd_7ecaf9a1:
    ...
    avt "\"Cóż... Nie wiem, czy Lampart by zrozumiał całą tą komputerową gadaninę. Jesteś pewny, że on wie to wszystko?\" "
...
translate polish s14_branch1_03_lpd_d3b2ce47:
    ...
    tig frown "\"Liao... to była tylko metafora. Takie sprawy są dla bogów wiedzą oczywistą. \" "

    tig frown "\"Poza tym, czy nie zapytałem się go czy wie, co czyni? Powiedział, że wie.\" "
...
translate polish s14_branch1_03_lpd_536aa52e:
    ...
    avt "\"Ale on nigdy nie powiedział tego, co wiedział. Ty go tylko zapytałeś, prawda?\" "
...
translate polish s14_branch1_03_lpd_a5efd533:
    ...
    avt "\"To musi być jakieś nieporozumienie... Nie wierzę w to, że może być osobą zdolną do zabicia kogoś.\" "
...
translate polish s14_branch1_03_lpd_44a40a78:
    ...
    tig angry "\"Chciałbym uwierzyć w to, ale nawet jeżeli nie wiedział, że to może cię zabić, on {i}musiał{/i} \ wiedzieć, że to cię skrzywdzi.\" "

    tig angry "\"Nie mogę mu tego wybaczyć.\" "
...
translate polish strings:
    ...
    new "\"Koniec końców, w co tak naprawdę wierzył Lampart?\" "
    ...
    new "Może rzeczywiście nie zrozumiał tego, co robił. "
    ...
    new "Tygrys ma rację, powienienem z nim zostać."
    ...
    new "Nie teraz, muszę porozmawiać z Tygrysem."
